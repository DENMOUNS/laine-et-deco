    ...
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div className="space-y-4">
          <button className="w-full flex items-center justify-center gap-4 py-4 bg-white border border-primary/10 rounded-2xl font-bold hover:bg-slate-50 transition-all shadow-sm">
          ...
          <button className="w-full flex items-center justify-center gap-4 py-4 bg-primary text-white rounded-2xl font-bold hover:bg-accent transition-all shadow-lg">
            <Phone size={20} />
        ...
        <div className="relative py-4">
          ...
          <div className="relative flex justify-center text-xs uppercase tracking-widest">
            <span className="bg-white px-4 text-primary/40">Ou</span>
          </div>
        </div>
        ...
        <form className="mt-4 space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <button
            type="submit"
            className="w-full bg-primary text-white py-4 rounded-2xl font-bold hover:bg-accent transition-all duration-300 flex items-center justify-center group"
          >
