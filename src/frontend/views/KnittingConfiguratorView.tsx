  ...
  const getAiColorAdvice = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/chat', {
        ...
        body: JSON.stringify({
          message: prompt,
          systemInstruction: 'Tu es un expert en mode et tricot.',
          responseSchema: {
            type: "OBJECT",
            properties: {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
        ...
        <p className="text-primary/70 max-w-md text-sm italic">
              ...
              <button
                ...
                className={`group relative p-6 rounded-[2.5rem] border transition-all duration-500 ${
                  selectedModel.id === model.id 
                    ...
                    : 'bg-white text-primary/70 border-primary/5 hover:border-accent/40'
                }`}
              >
          ...
          <div className="bg-card rounded-[3.5rem] p-10 md:p-12 border border-primary/5 shadow-sm">
            <div className="space-y-12">
              ...
              <div className="space-y-4">
                <h3 className="text-[10px] font-bold uppercase tracking-widest text-primary/70 flex items-center gap-2">
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  <h3 className="text-[10px] font-bold uppercase tracking-widest text-primary/70">Nuancier de Laine</h3>
                </div>
              ...
              <div className="bg-secondary/30 p-8 rounded-[2.5rem] border border-primary/5 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <p className="text-[10px] font-bold uppercase tracking-widest text-primary/70">Laine</p>
                    <p className="text-sm font-serif text-primary">4x 100g Mérinos</p>
                  </div>
                  <div className="space-y-1 text-right">
                    <p className="text-[10px] font-bold uppercase tracking-widest text-primary/70">Aiguilles</p>
                    <p className="text-sm font-serif text-primary">5mm Recommandé</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-[10px] font-bold uppercase tracking-widest text-primary/70">Niveau</p>
                    <p className="text-sm font-serif text-accent">Intermédiaire</p>
                  </div>
                  <div className="space-y-1 text-right">
                    <p className="text-[10px] font-bold uppercase tracking-widest text-primary/70">Temps</p>
              ...
              <div className="pt-8 border-t border-primary/5">
                <div className="flex justify-between items-end mb-8">
                  <div>
                    <p className="text-[10px] font-bold uppercase tracking-widest text-primary/70 mb-2">Prix du Kit Complet</p>
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs font-medium text-primary/70 underline decoration-accent/30">Livraison 48h</p>
                  </div>
                </div>
