  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        {BLOG_POSTS.map((post, index) => (
          ...
          >
            ...
            <div className="p-8 flex-grow flex flex-col">
              <div className="flex items-center gap-4 text-[10px] font-bold uppercase tracking-widest text-primary/70 mb-4">
              ...
              <p className="text-primary/70 text-sm mb-8 line-clamp-3 leading-relaxed">
                {post.excerpt}
              </p>
      ...
      <div className="mt-24 bg-secondary/50 p-12 md:p-20 rounded-[4rem] text-center">
        ...
        <p className="text-primary/70 mb-10 max-w-xl mx-auto">
