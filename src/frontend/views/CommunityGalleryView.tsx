    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
          ...
          <p className="text-primary/70 mt-4 text-lg max-w-2xl">
            ...
            <div className="p-6 space-y-4">
              ...
              {post.productsUsed && post.productsUsed.length > 0 && (
                <div className="pt-4 border-t border-primary/5 flex items-center gap-2 overflow-x-auto no-scrollbar">
                  <span className="text-[10px] font-bold uppercase tracking-widest text-primary/70 whitespace-nowrap">Produits :</span>
