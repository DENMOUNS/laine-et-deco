...
export default function App() {
  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, (currentUser) => {
      setUser(currentUser);
      if (currentUser) {
        WishlistService.getWishlist(currentUser.uid).then(productIds => {
  ...
  const addToWishlist = async (product: Product) => {
    ...
    setWishlist(prev => {
      ...
      WishlistService.addToWishlist(user.uid, product.id);
      ...
      <main className="flex-grow">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {currentView === 'quiz' && <QuizView onNavigate={handleNavigate} />}
            {currentView === 'custom-order' && <CustomOrderView onNavigate={handleNavigate} />}
            {currentView === 'patterns' && <PatternView onNavigate={handleNavigate} />}
