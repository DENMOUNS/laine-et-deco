import { Product, Category, Order, User, Review, BlogPost, LoginLog, RequestLog, Notification, SalesStat, Invoice, SiteConfig, ChatMessage, Conversation, Coupon, AdminRole, PromoEvent, Pack, PushNotification, Email, Expense, RMA, AbandonedCart, CustomerGroup, TaxRule, ShippingRule, CatalogPriceRule, NewsletterSubscriber, CommunityPost, Badge, UserProfile, City, NavItem, FAQ } from './types';

export const CATEGORIES: Category[] = [
  { id: '1', name: 'Laine', slug: 'laine', image: 'https://images.unsplash.com/photo-1584992236310-6edddc08acff?auto=format&fit=crop&q=80', count: 45, status: 'active' },
  { id: '2', name: 'Décoration', slug: 'decoration', image: 'https://images.unsplash.com/photo-1513519247341-36ba339ae785?auto=format&fit=crop&q=80', count: 28, status: 'active' },
  { id: '3', name: 'Accessoires', slug: 'accessoires', image: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&q=80', count: 15, status: 'active' },
  { id: '4', name: 'Kits', slug: 'kits', image: 'https://images.unsplash.com/photo-1544605510-99757736f165?auto=format&fit=crop&q=80', count: 12, status: 'active' },
  { id: '5', name: 'Modèles', slug: 'modeles', image: 'https://images.unsplash.com/photo-1459411552884-841db9b3cc2a?auto=format&fit=crop&q=80', count: 34, status: 'active' },
  { id: '6', name: 'Nouveautés', slug: 'nouveautes', image: 'https://images.unsplash.com/photo-1490481651871-ab68de25d43d?auto=format&fit=crop&q=80', count: 10, status: 'active' },
  { id: '7', name: 'Électronique', slug: 'electronique', image: 'https://images.unsplash.com/photo-1498049794561-7780e7231661?auto=format&fit=crop&q=80', count: 18, status: 'active' }
];

export const NAV_ITEMS: NavItem[] = [
  { id: 'nav-1', name: 'Boutique', view: 'shop', order: 1, status: 'active' },
];
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1599406561184-2195dfb4257f?auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    price: 12500,
    category: 'Kits',
    image: 'https://images.unsplash.com/photo-1544605510-99757736f165?auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    price: 12000,
    category: 'Laine',
    image: 'https://images.unsplash.com/photo-1459411552884-841db9b3cc2a?auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    price: 7500,
    category: 'Décoration',
    image: 'https://images.unsplash.com/photo-1603006373366-0428f52ef058?auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    price: 3500,
    category: 'Modèles',
    image: 'https://images.unsplash.com/photo-1517677208171-0bc6725a3e60?auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    price: 18500,
    category: 'Décoration',
    image: 'https://images.unsplash.com/photo-1563214811-0bbcd9991207?auto=format&fit=crop&q=80',
...
export const USERS: User[] = [
  { id: 'u1', name: 'Landry M.', email: 'landrymouns@gmail.com', role: 'admin', joinDate: '2023-01-15', orders: 5, status: 'active', points: 10000, loyaltyTier: 'Platinum' },
...
export const CATALOG_PRICE_RULES: CatalogPriceRule[] = [
  { id: 'cpr1', name: 'Promo Laine Mars', discountPercentage: 15, startDate: '2024-03-01', endDate: '2024-03-31', status: 'active' }
];
...
export const SITE_CONFIG: SiteConfig = {
  ...
  showSlider: true,
  sliderItems: [
    { id: 's1', image: 'https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?auto=format&fit=crop&q=80', title: 'Nouvelle Collection', subtitle: 'L\'alliance parfaite entre élégance et tendance' },
    { id: 's2', image: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&q=80', title: 'Boutique Premium', subtitle: 'Découvrez notre sélection exclusive' },
  ],
  customSections: [
