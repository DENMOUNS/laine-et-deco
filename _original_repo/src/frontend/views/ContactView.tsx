          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-8 rounded-3xl border border-primary/5 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-primary/60 leading-relaxed mb-1">+237 600 000 000</p>
                <p className="text-primary/40 text-sm">Lun-Ven, 9h à 18h</p>
              </div>
              ...
              <div className="bg-white p-8 rounded-3xl border border-primary/5 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-primary/60 leading-relaxed mb-1">contact@laine-deco.com</p>
                <p className="text-primary/40 text-sm">Nous répondons sous 24h</p>
              </div>
          ...
          >
            {submitted ? (
              <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-center bg-white rounded-[3xl]">
                ...
                <p className="text-primary/60 mb-8 text-lg">Nous avons bien reçu votre message et vous répondrons dans les plus brefs délais.</p>
                <Button 
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-wider text-primary/60 ml-2">Sujet</label>
                  <input
                    type="text"
                    required
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-wider text-primary/60 ml-2">Votre message</label>
                  <textarea
                    required
                    rows={6}
