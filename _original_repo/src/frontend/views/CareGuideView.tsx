    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
            ...
            <div className="space-y-8">
              {guide.tips.map((tip, i) => (
                <div key={i} className="flex gap-6">
                  <div className="flex-shrink-0 w-10 h-10 bg-secondary/50 rounded-xl flex items-center justify-center text-primary/40">
                    {tip.icon}
                  </div>
                  <div>
      ...
      <div className="mt-20 bg-primary p-12 md:p-20 rounded-[4rem] text-white text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <div className="px-8 py-4 bg-white/10 backdrop-blur-md rounded-2xl border border-white/10">
            <p className="text-xs font-bold uppercase tracking-widest text-white/40 mb-1">WhatsApp</p>
