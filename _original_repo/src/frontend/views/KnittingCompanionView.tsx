          ...
          >
            <div className="flex items-start justify-between mb-8">
              ...
              <div className="text-right">
                ...
                <p className="text-[10px] font-bold text-primary/40 uppercase tracking-widest">Progression</p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-6">
              <div className="flex items-center gap-8">
                <div className="text-center">
                  ...
                  <p className="text-[10px] font-bold text-primary/40 uppercase tracking-widest">Rangs faits</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl font-bold text-primary/20">{project.totalRows}</p>
                  <p className="text-[10px] font-bold text-primary/40 uppercase tracking-widest">Total visé</p>
                </div>
              </div>
