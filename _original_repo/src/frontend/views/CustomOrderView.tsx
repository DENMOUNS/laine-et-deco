    ...
    try {
      ...
      if (db) {
        await addDoc(collection(db, 'custom_order'), {
          ...
          userName: name.trim() || (user ? user.displayName || 'Anonyme' : 'Anonyme'),
  ...
  if (submitted) {
    return (
      <div className="max-w-3xl mx-auto px-4 py-32 text-center min-h-[70vh] flex flex-col items-center justify-center">
        ...
        <p className="text-primary/60 text-lg mb-10 max-w-xl">
      ...
      >
          ...
          <div className="space-y-6 pt-10 border-t border-primary/10">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-primary/60 leading-relaxed">Nous donnons forme à vos idées et validons avec vous le croquis et le choix des matériaux.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-primary/60 leading-relaxed">Votre pièce prend vie dans nos ateliers avec le plus grand soin et un savoir-faire authentique.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-primary/60 leading-relaxed">Recevez une création exclusive et raffinée, conçue spécifiquement pour vous.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-8 sm:p-10 lg:p-12 rounded-[2.5rem] shadow-2xl border border-primary/5 relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm text-primary/50 mb-8">Remplissez ce formulaire pour démarrer l'aventure.</p>

            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="space-y-1">
                  <label className="text-xs font-bold uppercase tracking-wider text-primary/60 ml-2">Nom complet</label>
                  <input
                    type="text"
                    required
                    className="w-full px-5 py-4 bg-[#F9F7F2] border border-transparent rounded-2xl focus:border-accent/30 focus:bg-white focus:ring-4 focus:ring-accent/10 transition-all text-primary placeholder:text-primary/30"
                ...
                <div className="space-y-1">
                  <label className="text-xs font-bold uppercase tracking-wider text-primary/60 ml-2">Email</label>
                  <input
                    type="email"
                    required
                    className="w-full px-5 py-4 bg-[#F9F7F2] border border-transparent rounded-2xl focus:border-accent/30 focus:bg-white focus:ring-4 focus:ring-accent/10 transition-all text-primary placeholder:text-primary/30"
              ...
              <div className="space-y-4">
                <div className="space-y-1">
                  <label className="text-xs font-bold uppercase tracking-wider text-primary/60 ml-2">Votre Idée / Projet</label>
                  <textarea 
                    required
                    rows={4}
                    className="w-full px-5 py-4 bg-[#F9F7F2] border border-transparent rounded-2xl focus:border-accent/30 focus:bg-white focus:ring-4 focus:ring-accent/10 transition-all resize-none text-primary placeholder:text-primary/30 leading-relaxed"
                ...
                <div className="space-y-1">
                  <label className="text-xs font-bold uppercase tracking-wider text-primary/60 ml-2">Matériaux souhaités</label>
                  <input
                    type="text"
                    required
                    className="w-full px-5 py-4 bg-[#F9F7F2] border border-transparent rounded-2xl focus:border-accent/30 focus:bg-white focus:ring-4 focus:ring-accent/10 transition-all text-primary placeholder:text-primary/30"
                ...
                <div className="space-y-1">
                  <label className="text-xs font-bold uppercase tracking-wider text-primary/60 ml-2">Dimensions approximatives</label>
                  <input 
                    type="text"
                    className="w-full px-5 py-4 bg-[#F9F7F2] border border-transparent rounded-2xl focus:border-accent/30 focus:bg-white focus:ring-4 focus:ring-accent/10 transition-all text-primary placeholder:text-primary/30"
              ...
              <p className="text-center text-[11px] text-primary/40 uppercase tracking-wider mt-4">
