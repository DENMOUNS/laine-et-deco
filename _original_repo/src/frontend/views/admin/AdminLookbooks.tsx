        ...
        <div className="bg-card p-8 rounded-[2rem] border border-primary/10 shadow-sm max-w-4xl mx-auto">
          <form onSubmit={handleSave} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="text-xs font-bold uppercase tracking-widest text-primary/60 mb-2 block">Titre</label>
                <input 
                  type="text" 
              ...
              <div>
                <label className="text-xs font-bold uppercase tracking-widest text-primary/60 mb-2 block">URL de l'image (Ex: https://images.unsplash.com/...)</label>
                <input 
                  type="url" 
                  className="input-field"
              ...
              <div className="md:col-span-2">
                <label className="text-xs font-bold uppercase tracking-widest text-primary/60 mb-2 block">Description courte</label>
                <textarea 
            ...
            <div className="border-t border-primary/10 pt-8 mt-8">
              ...
              <p className="text-primary/60 mb-6 text-sm">Sélectionnez les produits qui figurent sur cette image de lookbook.</p>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-primary/60">{product.price} FCFA</p>
                      </div>
