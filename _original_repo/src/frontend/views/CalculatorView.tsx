      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white p-8 rounded-[2.5rem] border border-primary/10 shadow-xl shadow-primary/5 space-y-10">
            ...
            <div className="space-y-4">
              <label className="text-[10px] font-bold uppercase tracking-widest text-primary/40 block">Quel est votre projet ?</label>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {GARMENT_OPTIONS.map((g, idx) => {
                  ...
                  return (
                    ...
                    >
                      <Icon size={20} className={garment.id === g.id ? 'text-[#e26d24]' : 'text-primary/40'} />
            ...
            {needsSize && (
              <div className="space-y-4">
                <label className="text-[10px] font-bold uppercase tracking-widest text-primary/40 block">Quelle taille ?</label>
            ...
            {/* Yarn Type */}
            <div className="space-y-4">
              <label className="text-[10px] font-bold uppercase tracking-widest text-primary/40 block">Quelle laine ?</label>
        ...
        >
          ...
          <div className="flex flex-col items-center mb-12">
            ...
            <p className="text-[10px] font-bold uppercase tracking-widest text-white/50 mb-2">Estimation finale</p>
          ...
          <div className="border-t border-b border-white/10 py-6 mb-8 space-y-3 text-center">
            ...
            <div className="text-sm">
              <span className="text-white/60">Laine : </span>
