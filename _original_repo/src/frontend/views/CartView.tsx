    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-24 min-h-[70vh] flex flex-col items-center justify-center">
        <motion.div 
          ...
          className="w-32 h-32 bg-primary/5 rounded-full flex items-center justify-center mb-8 text-primary/20"
        >
          <ShoppingBag size={64} />
        </motion.div>
                  ...
                  >
                    <div className="flex items-center gap-4 sm:gap-6 w-full md:w-auto">
                      ...
                      <div className="flex-grow">
                        <p className="text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.2em] text-primary/30 mb-1">{category}</p>
                        ...
                        {item.type === 'pack' && (
                          <p className="text-[10px] text-primary/40 font-bold mt-2 uppercase tracking-widest leading-none flex items-center gap-2">
                    ...
                    <div className="flex items-center justify-between md:justify-end w-full md:flex-grow gap-4 sm:gap-8 pt-4 md:pt-0 border-t md:border-t-0 border-primary/5">
                      ...
                      <button 
                        ...
                        className="p-2 sm:p-3 text-primary/20 hover:text-red-500 hover:bg-red-50 rounded-full transition-all"
                      >
