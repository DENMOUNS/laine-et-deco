        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="p-8 md:p-16 flex flex-col justify-center">
                ...
                {packProducts.map(p => (
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[10px] text-primary/40 font-bold uppercase">Quantité: {p.quantity} par unité</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="pt-8 border-t border-primary/5">
              ...
              <p className="mt-4 text-[10px] text-primary/40 text-center italic uppercase tracking-widest font-bold">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {packProducts.map(p => (
            ...
            >
              ...
              <p className="text-primary/60 text-sm mb-6 line-clamp-3">{p.description}</p>
              <Button 
                variant="outline" 
