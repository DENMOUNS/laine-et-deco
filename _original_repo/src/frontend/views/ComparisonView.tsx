      ...
      <div className="flex flex-wrap items-center justify-between mb-8 gap-4">
        <div>
          <button 
            ...
            className="flex items-center gap-2 text-primary/60 hover:text-accent font-bold text-sm mb-4 transition-colors"
          >
          ...
          <thead>
            <tr>
              <th className="w-1/4 p-4 text-left border-b-2 border-primary/10">
                <span className="text-xs font-bold uppercase tracking-widest text-primary/40">Caractéristiques</span>
              </th>
          ...
          <tbody>
            {allAttributes.map(key => (
              <tr key={key} className="border-b border-primary/5 hover:bg-secondary/20 transition-colors">
                <td className="p-4 py-6 text-sm font-bold text-primary/60 uppercase tracking-wider">{key}</td>
                {comparisonList.map(product => (
