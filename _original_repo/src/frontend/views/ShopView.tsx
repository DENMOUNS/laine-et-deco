      ...
      <div className="grid grid-cols-1 gap-2">
        {[
          ...
          <button
            ...
            className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all border ${selectedCondition === cond.id ? 'bg-primary text-white border-primary shadow-md' : 'bg-secondary text-primary/60 border-transparent hover:bg-secondary/80'}`}
          >
            {cond.icon}
            {cond.label}
          </button>
            ...
            <div className="relative flex-grow md:flex-grow-0">
              ...
              <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1">
                <button 
                  ...
                  className={`p-1.5 rounded-full transition-all ${isVoiceSearching ? 'bg-accent text-white animate-pulse' : 'text-primary/20 hover:text-accent hover:bg-primary/5'}`}
                ...
                {imagePreview ? (
                  <button 
                    ...
                    className="p-1.5 bg-secondary text-primary/60 rounded-full hover:bg-secondary/80 transition-colors"
                  >
                    <X size={14} />
                  </button>
                ) : (
