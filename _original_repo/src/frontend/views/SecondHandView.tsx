    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {secondHandProducts.length > 0 ? (
        ...
        <div className="text-center py-20 bg-slate-50 rounded-[3rem] border border-dashed border-primary/10">
          <Recycle size={48} className="mx-auto text-primary/20 mb-4" />
          <p className="text-primary/60 font-serif text-xl">Notre stock de deuxième main est actuellement vide.</p>
          <button 
