    ...
    >
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-4">
          <Button 
            ...
            size="sm"
            onClick={onClear} 
            className="text-xs font-bold uppercase tracking-widest text-primary/40 hover:text-red-500 flex items-center gap-2 h-auto"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div key={product.id} className="relative group bg-secondary/10 rounded-2xl p-4 border border-primary/5">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-[10px] text-primary/40 uppercase tracking-widest mt-1">{product.category}</p>
              </div>
            </div>
        ...
        {comparisonList.length < 3 && (
          <div className="border-2 border-dashed border-primary/10 rounded-2xl flex flex-col items-center justify-center p-6 text-primary/20">
