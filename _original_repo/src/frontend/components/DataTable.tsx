...
export function DataTable<T extends { id?: string | number }>({
  ...
  return (
    <div className="bg-card rounded-[2.5rem] border border-primary/5 shadow-sm overflow-hidden flex flex-col min-w-0">
      {/* Header */}
      <div className="p-6 md:p-8 border-b border-primary/5 flex flex-col xl:flex-row xl:items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-4 w-full xl:w-auto">
          ...
          <div className="flex items-center gap-2 bg-secondary/50 p-2 rounded-2xl shrink-0">
            <span className="text-xs font-bold text-primary/40 uppercase tracking-widest pl-2">Export</span>
          ...
          <thead>
            <tr className="bg-secondary/30">
              {columns.map((col, i) => (
                <th 
                  key={i} 
                  className="px-6 py-5 text-left text-[11px] font-bold uppercase tracking-[0.1em] text-primary/50 first:pl-8 last:pr-8 border-b border-primary/5"
                >
      ...
      <div className="p-6 md:p-8 border-t border-primary/5 bg-secondary/10 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <span className="text-xs font-bold text-primary/40 uppercase tracking-widest">Afficher</span>
          <select 
            value={itemsPerPage} 
          ...
          <span className="text-xs font-bold text-primary/40 uppercase tracking-widest">par page</span>
        </div>
