...
import { AdminProductDetailView } from '../views/AdminProductDetailView';
...
import { CustomPackBuilderView } from '../views/CustomPackBuilderView';
...
import { KnittingConfiguratorView } from '../views/KnittingConfiguratorView';
import { OrderSuccessView } from '../views/OrderSuccessView';
import { KnittingCompanionView } from '../views/KnittingCompanionView';
import { PatternGeneratorView } from '../views/PatternGeneratorView';
...
export const MainContent: React.FC<MainContentProps> = ({
  ...
  const isAuthorizedAdmin = user?.email === 'landrymouns@gmail.com';
  ...
  if (isAdminView && !isAuthorizedAdmin) {
    // Redirect handled by individual components or here
    // Let's handle it here for consistency
    if (!user) {
      handleNavigate('auth');
