          ...
          <div className="fixed inset-0 flex items-center justify-center z-[101] p-4 pointer-events-none">
            ...
            >
              <div className="flex items-center justify-between p-6 md:p-8 border-b border-primary/5 shrink-0 bg-accent/5">
                ...
                <button
                  onClick={onClose}
                  className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-primary/60 hover:text-accent hover:bg-accent/10 transition-all border border-primary/5 shadow-sm ml-auto"
                >
                  <X size={20} />
                </button>
              </div>
