          ...
          {showReturnForm ? (
            ...
            >
              ...
              <form onSubmit={handleReturnSubmit} className="space-y-4">
                <div>
                  <label className="block text-[10px] font-bold uppercase tracking-widest text-primary/40 mb-2">Raison du retour</label>
                  <textarea 
                    value={returnReason}
            ...
            <>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-x-4 gap-y-1 mt-1">
                            <p className="text-xs text-primary/60">Prix unitaire: <span className="font-bold">{item.price.toLocaleString()} FCFA</span></p>
                            <p className="text-xs text-primary/60">Qté: <span className="font-bold">{item.quantity}</span></p>
                          </div>
                        </div>
                      </div>
                      <div className="text-left sm:text-right">
                        <p className="text-[10px] uppercase tracking-widest text-primary/40 font-bold mb-1">Sous-total</p>
              ...
              <div className="bg-primary/5 rounded-2xl p-6 border border-primary/5 space-y-4">
                <div className="flex justify-between items-center text-sm">
                  <p className="text-primary/60">Sous-total Articles</p>
                ...
                <div className="flex justify-between items-center text-sm">
                  <p className="text-primary/60">Frais de livraison</p>
                  <p className="font-bold text-primary">
                ...
                <div className="bg-slate-50 p-6 rounded-2xl flex flex-col justify-between">
                  <div>
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <p className="text-[10px] font-bold uppercase tracking-widest text-primary/40">Livraison</p>
                    </div>
                    ...
                    <div className="mt-4 pt-4 border-t border-primary/10 space-y-2">
                      {selectedOrder.carrier && (
                        <div className="flex justify-between text-sm">
                          <span className="text-primary/60">Transporteur:</span>
                          <span className="font-bold text-primary">{selectedOrder.carrier}</span>
                        </div>
                      )}
                      {selectedOrder.trackingNumber && (
                        <div className="flex justify-between text-sm">
                          <span className="text-primary/60">N° de suivi:</span>
