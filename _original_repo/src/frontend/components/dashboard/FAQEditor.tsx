        ...
        <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="md:col-span-2">
              <label className="block text-xs font-bold uppercase tracking-widest text-primary/40 mb-2">Question</label>
              <input
                type="text"
                required
            ...
            <div className="md:col-span-2">
              <label className="block text-xs font-bold uppercase tracking-widest text-primary/40 mb-2">Réponse</label>
              <textarea
                required
                rows={4}
            ...
            <div>
              <label className="block text-xs font-bold uppercase tracking-widest text-primary/40 mb-2">Catégorie</label>
              <select
            ...
            <div>
              <label className="block text-xs font-bold uppercase tracking-widest text-primary/40 mb-2">Ordre d'affichage</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-xs font-bold uppercase tracking-widest text-primary/40 mb-2">Statut</label>
              <select
