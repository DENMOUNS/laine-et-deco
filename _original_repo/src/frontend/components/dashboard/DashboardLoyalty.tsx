    ...
    <div className="space-y-10">
      <div className="bg-gradient-to-br from-primary to-accent p-12 rounded-[3rem] text-white relative overflow-hidden shadow-2xl">
        <div className="relative z-10">
          <div className="flex items-center gap-3 text-white/60 font-bold uppercase tracking-widest text-xs mb-4">
            <Sparkles size={16} />
            <span>Programme de Fidélité</span>
          </div>
          <h3 className="text-4xl font-serif mb-2">Votre Statut : <span className="italic">Artisan Élite</span></h3>
          ...
          <div className="flex items-end gap-4">
            ...
            <div className="mb-2">
              <p className="text-xs font-bold uppercase tracking-widest text-white/40">Points Cumulés</p>
      ...
      <div className="bg-accent/5 p-10 rounded-[3rem] border border-accent/20 flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="flex-grow text-center md:text-left">
          <h4 className="text-2xl font-serif text-primary mb-2">Gagnez des points en parrainant !</h4>
          <p className="text-primary/60 max-w-xl mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-grow px-6 py-3 bg-white rounded-2xl border border-primary/10 font-mono text-xs flex items-center justify-between text-primary/40 truncate">
            ...
            <Button 
              ...
              className="rounded-2xl px-8 h-12 font-bold shadow-lg shadow-accent/20"
            >
              Copier mon lien
            </Button>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-white p-8 rounded-[2.5rem] border border-primary/5 shadow-sm text-center">
          ...
          <p className="text-xs text-primary/60">Gagnez 1% de vos achats en points de fidélité.</p>
        </div>
        <div className="bg-white p-8 rounded-[2.5rem] border border-primary/5 shadow-sm text-center">
          ...
          <p className="text-xs text-primary/60">20 points pour chaque premier achat parrainé.</p>
        </div>
        <div className="bg-white p-8 rounded-[2.5rem] border border-primary/5 shadow-sm text-center">
          ...
          <p className="text-xs text-primary/60">Débloquez des avantages en montant de niveau.</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {badges.map(badge => (
              ...
              >
                ...
                <p className="text-[10px] text-primary/60 leading-tight">{badge.description}</p>
              </div>
            ))}
          </div>
        </div>
              ...
              <div key={i} className="flex items-center justify-between p-4 bg-secondary/30 rounded-2xl border border-primary/5">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-primary/40 font-bold uppercase tracking-widest">{reward.cost} Points</p>
                  </div>
                </div>
                <Button 
