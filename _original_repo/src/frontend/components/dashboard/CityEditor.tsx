    ...
    <Modal isOpen={isOpen} onClose={onClose} title={city ? 'Modifier la Ville' : 'Ajouter une Ville'}>
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-1">
          <label className="text-[10px] font-bold uppercase tracking-widest text-primary/40">Nom de la ville</label>
          <input
            type="text"
            required
            value={formData.name}
        ...
        <div className="space-y-1">
          <label className="text-[10px] font-bold uppercase tracking-widest text-primary/40">Slug (URL/ID)</label>
          <input
            type="text"
            required
            value={formData.slug}
        ...
        <div className="space-y-1">
          <label className="text-[10px] font-bold uppercase tracking-widest text-primary/40">Prix de livraison (FCFA)</label>
          <input
            type="number"
            required
