      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1">
            <label className="text-[10px] font-bold uppercase tracking-widest text-primary/40">Code</label>
            <input
              type="text"
              required
              value={formData.code}
          ...
          <div className="space-y-1">
            <label className="text-[10px] font-bold uppercase tracking-widest text-primary/40">Type</label>
            <select
              value={formData.type}
          ...
          <div className="space-y-1">
            <label className="text-[10px] font-bold uppercase tracking-widest text-primary/40">Valeur</label>
            <input
              type="number"
          ...
          <div className="space-y-1">
            <label className="text-[10px] font-bold uppercase tracking-widest text-primary/40">Date d'expiration</label>
            <input
              type="date"
              required
          ...
          <div className="space-y-1">
            <label className="text-[10px] font-bold uppercase tracking-widest text-primary/40">Limite d'utilisation</label>
            <input
              type="number"
          ...
          <div className="space-y-1">
            <label className="text-[10px] font-bold uppercase tracking-widest text-primary/40">Statut</label>
            <select
        ...
        <div className="space-y-1">
          <label className="text-[10px] font-bold uppercase tracking-widest text-primary/40">Restreindre à un utilisateur (Optionnel)</label>
          <select
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <label htmlFor="freeShipping" className="text-xs font-bold text-primary/60">
